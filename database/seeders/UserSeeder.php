...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $UsersData = [
            [
                'user' => ['nama' => 'Mas Gib Ran', 'email' => 'masgib@gmail.com', 'email_verified_at' => now(), 'password' => Hash::make('password123'), 'path_profil' => 'images/profile/default_profile.jpg', 'role' => 'Admin', 'remember_token' => Str::random(10)],
                'detail' => ['tanggal_lahir' => '1987-10-01', 'jenis_kelamin' => 'Tidak Ingin Memberi Tahu', 'no_telepon' => '081117042204', 'domisili' => 'Solo']
            ],
            [
                'user' => ['nama' => 'mayadiG', 'email' => 'mayadiG@gmail.com', 'email_verified_at' => now(), 'password' => Hash::make('password123'), 'path_profil' => 'images/profile/default_profile.jpg', 'role' => 'Volunteer', 'remember_token' => Str::random(10)],
            ...
            [
                'user' => ['nama' => 'FerdyanG', 'email' => 'ferdyG@gmail.com', 'email_verified_at' => now(), 'password' => Hash::make('password123'), 'path_profil' => 'images/profile/default_profile.jpg', 'role' => 'Volunteer', 'remember_token' => Str::random(10)],
